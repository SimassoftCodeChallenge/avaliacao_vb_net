...
5. Deve escrita obrigatoriamente em: VB# com SQL Server (pode ser express ou LocalDB) 
6. Ser simples de instalar e rodar a partir das instruções fornecidas, 
7. Ter um testes automatizados para a funcionalidade pedida
